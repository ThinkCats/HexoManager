...
gulp.task('browserify', ['browserify-vendor'], function() {
    return browserify('src/view/main.js')
...
gulp.task('browserify-watch', ['browserify-vendor'], function() {
    var bundler = watchify(browserify('src/view/main.js', watchify.args));
    bundler.external(dependencies);
    bundler.transform(babelify, { presets: ['es2015', 'react','stage-1'] })
